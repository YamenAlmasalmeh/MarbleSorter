...
marbleType = '';
colorVals = [83  81  6   4   6  4; %big red
             14  12  33  31  5  3; %big green
             25  23  31  29  72 70; %big blue
             126 120 41  37  4  2; %big yellow
             132 131 95  94  87 85; %big white
             49	 47  8   6   7  5; %small red
             14  11  26  24  12 10; %small green
             11  8   17  15  35 33; %small blue
             99  97  114 112 98	95; %small white
             43  41  50  49  46 44; %HDPE
             73  71  45  43  11 9; %small yellow
             20  17  19  17  14 12;]; %steel
         
colorVals(:,1:2:6) = colorVals(:,1:2:6)+expRan;
colorVals(:,2:2:6) = colorVals(:,2:2:6)-expRan;
